...
// ver 1.6                                                       //
// Application:  define XML Element types		                 //
// Platform:    Dell XPS 2720, Win 8.1 Pro, Visual Studio 2013   //
// Author:      PavanKumar Bodineni, 1 315-751-4931              //
//              pbodinen@sye.edu	                             //
///////////////////////////////////////////////////////////////////
...
bool DocElement::addChild(std::shared_ptr<AbstractXmlElement> pChild)
{
  ...
  {
	  if ((dynamic_cast<XmlDeclarElement*>(pChild.get()))){
		  if (hasXmlDec())return false;
